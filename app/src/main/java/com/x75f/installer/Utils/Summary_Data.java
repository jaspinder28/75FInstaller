...
public class Summary_Data implements Serializable {
    ...
    public Summary_Data(String ccu_name, String date_time, int building_no_cooler, int building_no_hotter, int user_no_cooler, int user_no_hotter, int cm_cur_temp, int cm_cur_humidity, int cooling_stage_1, int cooling_stage_2, int heating_stage_1, int heating_stage_2, int fan_stage_1, int fan_stage_2, int humidifier, boolean isEconomizerAvailable, boolean isPaired, int analog1_damperPos, int analog2_damperPos, int analog3_damperPos, int analog4_damperPos, double mInsideAirEnthalpy, double mOutsideAirEnthalpy, int mOutsideAirTemperature, int mOutsideAirMaxTemp, int mOutsideAirMinTemp, int mOutsideAirHumidity, int mOutsideAirMaxHumidity, int mOutsideAirMinHumidity, int mCO2Level, int mCO2LevelThreshold, int mMixedAirTemperature, int mReturnAirTemperature, int mDamperPos, String zone_summary) {
